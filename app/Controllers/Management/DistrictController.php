...
use App\Config;
use App\Functions;
use App\Models\TblSetupDistrict;
...
class DistrictController extends Controller
{
    public function getIndex($request, $response)
    {
        ...
        //region Render Page
        return $this->view->render($response, 'management/district/index.twig', $returnData);
        //endregion
    }
    ...
    public function getNew($request, $response)
    {
        ...
        //region Render Page
        return $this->view->render($response, 'management/district/new.twig', $returnData);
        //endregion
    }
    ...
    public function postNew($request, $response)
    {
        ...
        try {
            ...
            if ($validation->failed()) {
                ...
                return $response->withRedirect($this->router->pathFor('management-district-new'));
            }
            //endregion
            ...
            if (!empty($request->getParam('town_id'))) {
                $townId = (int)$request->getParam('town_id');
            }
            ...
            $table = TblSetupDistrict::create($data);
            //endregion
            ...
            if (!empty($table) && !empty($table->get()) && !$table->get()->isEmpty()) {
                if ((int)$table->id > 0) {
                    ...
                    return $response->withRedirect($this->router->pathFor('management-district'));
                }
                else {
                    //region Set Flash Message
    ...
    public function getEdit($request, $response, $args)
    {
        ...
        try {
            ...
            if (!is_null($args['id'])) {
                ...
                //region Table
                $mainTable = $this->db->table('tbl_setup_district')->where('id', $id);
                //endregion
        ...
        //region Render Page
        return $this->view->render($response, 'management/district/edit.twig', $returnData);
        //endregion
    }
        ...
        try {
            ...
            if (!is_null($args['id'])) {
                ...
                if ($validation->failed()) {
                    ...
                    return $response->withRedirect($this->router->pathFor('management-district-edit', ['id' => $id]));
                }
                //endregion
                ...
                $table = TblSetupDistrict::where('id', $id)->update($data);
                //endregion
    ...
    public function getDelete($request, $response, $args)
    {
        ...
        try {
            ...
            if (!is_null($args['id'])) {
                ...
                $table = TblSetupDistrict::where('id', $id)->delete();
                //endregion
