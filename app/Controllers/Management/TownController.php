...
class TownController extends Controller
{
    public function getIndex($request, $response)
    {
        ...
        //region Render Page
        return $this->view->render($response, 'management/town/index.twig', $returnData);
        //endregion
    }
    ...
    public function getNew($request, $response)
    {
        ...
        //region Render Page
        return $this->view->render($response, 'management/town/new.twig', $returnData);
        //endregion
    }
    ...
    public function postNew($request, $response)
    {
        ...
        try {
            ...
            if ($validation->failed()) {
                ...
                return $response->withRedirect($this->router->pathFor('management-town-new'));
            }
            //endregion
            ...
            if (!empty($request->getParam('city_id'))) {
            ...
            $table = TblSetupTown::create($data);
            //endregion
            ...
            if (!empty($table) && !empty($table->get()) && !$table->get()->isEmpty()) {
                if ((int)$table->id > 0) {
                    ...
                    return $response->withRedirect($this->router->pathFor('management-town'));
                }
                else {
                    //region Set Flash Message
    ...
    public function getEdit($request, $response, $args)
    {
        ...
        try {
            ...
            if (!is_null($args['id'])) {
                ...
                //region Table
                $mainTable = $this->db->table('tbl_setup_town')->where('id', $id);
                //endregion
        ...
        //region Render Page
        return $this->view->render($response, 'management/town/edit.twig', $returnData);
        //endregion
    }
        ...
        try {
            ...
            if (!is_null($args['id'])) {
                ...
                if ($validation->failed()) {
                    ...
                    return $response->withRedirect($this->router->pathFor('management-town-edit', ['id' => $id]));
                }
                //endregion
                ...
                $table = TblSetupTown::where('id', $id)->update($data);
                //endregion
    ...
    public function getDelete($request, $response, $args)
    {
        ...
        try {
            ...
            if (!is_null($args['id'])) {
                ...
                $table = TblSetupTown::where('id', $id)->delete();
                //endregion
