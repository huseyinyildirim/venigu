...
class JobController extends Controller
{
    public function getIndex($request, $response)
    {
        ...
        //region Render Page
        return $this->view->render($response, 'management/job/index.twig', $returnData);
        //endregion
    }
    ...
    public function getNew($request, $response)
    {
        ...
        //region Render Page
        return $this->view->render($response, 'management/job/new.twig', $returnData);
        //endregion
    }
    ...
    public function postNew($request, $response)
    {
        ...
        try {
            ...
            if ($validation->failed()) {
                ...
                return $response->withRedirect($this->router->pathFor('management-job-new'));
            }
            //endregion
            ...
            if (!empty($table) && !empty($table->get()) && !$table->get()->isEmpty()) {
                if ((int)$table->id > 0) {
                    ...
                    return $response->withRedirect($this->router->pathFor('management-job'));
                }
                else {
                    //region Set Flash Message
    ...
    public function getEdit($request, $response, $args)
    {
        ...
        //region Render Page
        return $this->view->render($response, 'management/job/edit.twig', $returnData);
        //endregion
    }
        ...
        try {
            ...
            if (!is_null($args['id'])) {
                ...
                if ($validation->failed()) {
                    ...
                    return $response->withRedirect($this->router->pathFor('management-job-edit', ['id' => $id]));
                }
                //endregion
                ...
                $table = TblJob::where('id', $id)->update($data);
                //endregion
    ...
    public function getDelete($request, $response, $args)
    {
        ...
        try {
            ...
            if (!is_null($args['id'])) {
                ...
                $table = TblJob::where('id', $id)->delete();
                //endregion
